        ...
        try:
            self.cursor.execute(
                ...
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s)""", (
                    ...
                    self.xstr(item['description']).encode('utf-8'), self.xstr(item['keywords']).encode('utf-8'),
                    self.xstr(item['hyperlinks']).encode('utf-8'), self.xstr(item['keywordInURL']).encode('utf-8')
                )
            )
